...
public class LabTest1 {
    ...
    /**
     * Sorts from smallest to largest.
     * Goes through the array while it is not sorted and goes through it twice
     * in one loop, making sure that it is all sorted.
     * @param unsorted The unsorted array to be sorted.
     */
    ...
    /**
     * Prints the array in the order that it is currently in.
    ...
    public static void main(String[] args) {
        labtest1.LabTest1 obj = new labtest1.LabTest1();
